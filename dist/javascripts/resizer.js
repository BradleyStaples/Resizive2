...
(function () {
    ...
    Resizive.prototype.assignElements = function () {
        Object.keys(this.elementSelectors).forEach(function (selector) {
            this.elements[selector] = $(this.elementSelectors[selector]);
        }.bind(this));
    };
    ...
    Resizive.prototype.setKeyBindings = function () {
        ...
        this.k.bindKeys('s', 'keydown', this.start.bind(this));
        this.k.bindKeys('e', 'keydown', this.end.bind(this));
        this.k.bindKeys('p', 'keydown', this.pause.bind(this));
        this.k.bindKeys('r', 'keydown', this.resume.bind(this));
        this.k.bindKeys(['down', 'left', '-'], 'keydown', this.minus.bind(this));
        this.k.bindKeys(['up', 'right', '+'], 'keydown', this.plus.bind(this));
    };
