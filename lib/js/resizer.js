...
(function() {
  ...
  Resizive = (function() {
    ...
    Resizive.prototype.assignElements = function() {
      var element, selector, _ref, _results;
      _ref = this.elementSelectors;
      _results = [];
      for (element in _ref) {
        selector = _ref[element];
        if (!this.elements[element] || !this.elements[element].length) {
          _results.push(this.elements[element] = $(selector));
        } else {
    ...
    Resizive.prototype.parseTemplates = function() {
      ...
      for (_i = 0, _len = templates.length; _i < _len; _i++) {
        ...
        _results.push(this.parseTemplate(template));
      }
      return _results;
    };
