...
Resizive.prototype.createConfig = function (url) {
    ...
    this.constructor.prototype.config = {
        ...
        snap: values.snap,
        stepDuration: values.step_duration,
        stepIncrememnt: values.step_increment,
        animationDuration: values.animation_duration,
        animationIncrement: values.animation_increment,
        minHeight: 320,
