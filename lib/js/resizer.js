...
Resizive.prototype.setBindings = function () {
    ...
    this.elements.body.on('click', this.selectors.phones_button, this.showDropdown.bind(this));
    this.elements.body.on('click', this.selectors.tablets_button, this.showDropdown.bind(this));
...
Resizive.prototype.showDropdown = function (event) {
    var $target = $(event.target);
    var dropdown_class = $target.data('dropdown');
